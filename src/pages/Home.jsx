                ...
                <div class="widget-area">
                  <div class="sidebar-widget widget-about mb-50 pt-30 pr-30 pb-30 pl-30 bg-white border-radius-5 has-border  wow fadeInUp animated">
                    ...
                    <p class="font-medium text-muted">
                      Hi, Im Stenven, a Florida native, who left my career in
                  ...
                  <div class="sidebar-widget widget_instagram wow fadeInUp animated">
                    ...
                    <div class="instagram-gellay">
                      <ul class="insta-feed">
                        <li>
                          <a
                            href="https://demos.alithemes.com/html/stories/demo/assets/imgs/thumbnail-3.jpg"
                            class="play-video"
                            data-animate="zoomIn"
                            data-duration="1.5s"
                            data-delay="0.1s"
                        ...
                        <li>
                          <a
                            href="https://demos.alithemes.com/html/stories/demo/assets/imgs/thumbnail-4.jpg"
                            class="play-video"
                            data-animate="zoomIn"
                            data-duration="1.5s"
                            data-delay="0.1s"
                        ...
                        <li>
                          <a
                            href="https://demos.alithemes.com/html/stories/demo/assets/imgs/thumbnail-5.jpg"
                            class="play-video"
                            data-animate="zoomIn"
                            data-duration="1.5s"
                            data-delay="0.1s"
